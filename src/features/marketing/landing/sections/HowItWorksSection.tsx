...
export default function HowItWorksSection({
  ...
  return (
    <section className="relative min-h-screen overflow-hidden bg-white px-6 py-20 lg:px-8">
      <LandingNavbar onNavigate={onNavigate} />

      <div className="mx-auto flex min-h-screen w-full max-w-7xl items-center pt-16">
